document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    ...
    de: {
      ...
      kb_intro_desc: "Email Campaign Manager v1.4 ist eine leistungsstarke Desktop-Anwendung zum Versenden schöner, personalisierter E-Mail-Kampagnen. Verwalten Sie Kampagnen, planen Sie Versendungen, führen Sie A/B-Tests durch und nutzen Sie erweiterte Vorlagen - alles in einem professionellen Tool!",
    ...
    it: {
      ...
      kb_intro_desc: "Email Campaign Manager v1.4 è una potente applicazione desktop per inviare campagne email personalizzate e professionali. Gestisci campagne, pianifica invii, esegui test A/B e usa template avanzati - tutto in un unico strumento professionale!",
